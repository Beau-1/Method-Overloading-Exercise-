...
//+Create a method named Add, that accepts two integers and returns the sum of those two integers - Done
//+ Now create an overload of the Add method to account for being able to add two decimals together - Done
